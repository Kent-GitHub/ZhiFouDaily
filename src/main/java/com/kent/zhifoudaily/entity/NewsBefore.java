...
public class NewsBefore {
    ...
    private List<NewsLatest.StoriesBean> stories;

    public static NewsBefore objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), NewsBefore.class);
    ...
    public void setStories(List<NewsLatest.StoriesBean> stories) {
